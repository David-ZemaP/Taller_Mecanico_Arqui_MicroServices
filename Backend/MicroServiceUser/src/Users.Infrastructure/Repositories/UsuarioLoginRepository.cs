...
namespace Taller_Mecanico_Users.Infrastructure.Repositories
{
    public class UsuarioLoginRepository : IUsuarioLoginRepository
    {
        ...
        public async Task<Result> AddAsync(UsuarioLogin entity)
        {
            ...
            try
            {
                ...
                command.CommandText = @"
                    INSERT INTO usuariologin (email, passwordhash, activo, requierecambiopassword, creadopor, rolid) 
                    VALUES (@Email, @PasswordHash, @Activo, @RequiereCambioPassword, @CreadoPor, @RolId)
