...
namespace Taller_Mecanico_Users.Application.UseCases.Auth
{
    /// <summary>
    ...
    public class LoginUseCase
    {
        ...
        private readonly Taller_Mecanico_Users.Application.Interfaces.IJwtTokenGenerator _tokenGenerator;

        public LoginUseCase(
            IUsuarioLoginRepository loginRepository,
            Domain.Interfaces.IPasswordHasher passwordHasher,
            Taller_Mecanico_Users.Application.Interfaces.IJwtTokenGenerator tokenGenerator)
        {
